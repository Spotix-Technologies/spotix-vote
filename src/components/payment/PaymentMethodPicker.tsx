 ...
 *
 * Platform-wide "How do you wanna pay?" step, shown BEFORE any Paystack
 * checkout opens across the app — votes (poll/[pollId]/VoteModal.tsx),
 * election form fees (election/[electionId]/office/[officeId]/page.tsx
 * and its payment-resume flow), and anywhere else that takes a payment
 * in future. Moved here from poll/[pollId]/components/payment/ — it
 * never actually depended on anything poll-specific, so every other
 * payment flow was reimplementing (or, before this pass, skipping
 * entirely) this same picker instead of sharing it.
 */
